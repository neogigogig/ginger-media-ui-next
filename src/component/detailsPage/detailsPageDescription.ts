export const description: { [key: string]: string } = {
  ...
  busShelter:
    `Bus shelters in {{city}} provide an excellent advertising opportunity due to their strategic locations along busy streets and near public transportation stops. They offer exposure to pedestrians and commuters waiting for buses, thereby ensuring high visibility for advertisements displayed on them.`,
  unipole:
    `Unipole advertisements in {{city}} are single-sided structures often installed along major roads and highways. They offer excellent visibility to vehicular traffic, making them effective for promoting brands and products to motorists. Unipoles are typically illuminated for increased visibility during the day and night.`,
};
    ...
    "hoarding": [
      {
        ...
        "answer": "Hoardings in {{city}} improve long-term brand recall and offer wide reach. They are typically found in hyperlocal areas with large crowds which offer high visibility to passersby, pedestrians, and commuters. As people quickly notice them, Hoardings attract potential customers and maintain brand awareness. Hoarding Ads are generally used to showcase new products/services/offers."
      },
      {
        "question": "What is Hoarding Advertisement in {{city}}?",
        "answer": "Hoarding Advertisement in {{city}} is a form of outdoor advertising which takes many forms and features branding and other business information. Hoarding Advertisement in {{city}} offers high visibility depending on their positioning and size. Place Your Hoarding Ads Now!"
      },
      {
        "question": "What are the benefits of Hoarding Ads in {{city}}?",
        "answer": "Hoardings are one of the oldest forms of advertising and help improve brand positioning as well as demand generation. Hoardings offer brands a good return on investment by generating valuable leads. Calculate Your Return On Investment With TMA!"
      },
      {
